...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .botonmasgrande {
            width: 150px; /* Ancho de los botones ajustado */
            margin: 5px;
        }
    </style>
</asp:Content>
        ...
        <div class="user-card">
            ...
            <div class="form-group">
                ...
                <div class="button-container11">
                    <asp:Button Text="Editar" CssClass="btn btn-success botonmasgrande" runat="server" />
                    <asp:Button Text="Volver" CssClass="btn btn-danger botonmasgrande" runat="server" />
                </div>
            </div>
        </div>
        <br />
